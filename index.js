function reverseStr(str) {
  ...
  function checkPalindromeForAllDateFormats(date){
    ...
    for(var i=0; i < listOfPalindromes.length; i++){
      if(palindromeCheck(listOfPalindromes[i])){
        flag = true;
        break;
      }
    }
  ...
  function getNextPalindromeDate(date){
    ...
    while(1){
      count++;
      var palindromeCheck = checkPalindromeForAllDateFormats(nextDate);
      if(palindromeCheck){
        break;
      }
  ...
  function clickHandler(e){
    ...
    if(bdayStr !== ''){
      ...
      var palindromeCheck = checkPalindromeForAllDateFormats(date);
      if(palindromeCheck){
  ...
  showBtnRef.addEventListener('click', clickHandler);isp